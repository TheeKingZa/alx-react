...
// Describe block for tests related to course action creators
describe("tests for action creators", () => {
  
  // Test case to ensure selectCourse action creator returns the correct action object
  ...
  // Test case to ensure unSelectCourse action creator returns the correct action object
