...
function Login(props) {
  // State variables to manage email, password, and submit button enable/disable
  ...
  const handleLoginSubmit = (e) => {
    e.preventDefault();
    // Call the logIn function passed as a prop with email and password values
...
// PropTypes for the logIn function prop
Login.propTypes = {
